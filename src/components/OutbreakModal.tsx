...
function caseLabel(ob: Outbreak): string {
  if (ob.caseCount != null) return ob.caseCount.toLocaleString();
  return ob.caseCountText ?? "See advisory";
}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        {ob.detailed && ob.guidance && (
          <div>
            <h4 className="mb-2 text-sm font-semibold">What to know</h4>
        ...
        {ob.detailed && ob.namedEntities ? (
          <div>
            <h4 className="mb-1 text-sm font-semibold">Named in the official record</h4>
            <p className="mb-2 text-xs text-muted-foreground">
              Only companies FDA or CDC named — or that sell a recalled branded product. Not a list
              of "unsafe stores."
            </p>
          ...
          <div className="rounded-md border border-dashed p-3 text-sm text-muted-foreground">
            This outbreak is tracked live from the FDA CORE table. Detailed named entities and
            guidance haven't been compiled for it yet — open the FDA investigation for the latest
            official information, including any advice and recalls.
            {ob.recallInitiated && (
